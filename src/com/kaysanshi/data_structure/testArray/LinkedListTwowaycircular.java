...
public class LinkedListTwowaycircular {
     ...
     * //结点域
     * //指针域
     * public com.kaysanshi.data_structure.testArray.Node next;
     * <p>
     * //前一个指针域
     * public com.kaysanshi.data_structure.testArray.Node privious;
     * <p>
     ...
     * }
     * <p>
     * public Node(long data, com.kaysanshi.data_structure.testArray.Node next) {
     * this.data = data;
     * this.next = next;
     * }
     * <p>
     * public Node(long data, com.kaysanshi.data_structure.testArray.Node next, com.kaysanshi.data_structure.testArray.Node privious) {
     * this.data = data;
     * this.next = next;
